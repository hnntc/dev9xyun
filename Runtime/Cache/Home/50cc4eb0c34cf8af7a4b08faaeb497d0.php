...
<section id="contents"> 
	 <ul class="tab-nav nav">
		<li class=""><a href="<?php echo addons_url('Weibo://Weibo/lists');?>">微博列表<b class="arrow fa fa-sort-up"></b></a></li>
		<li class=""><a href="<?php echo addons_url('Weibo://Grant/lists');?>">授权页面<b class="arrow fa fa-sort-up"></b></a></li>
		<li class="current"><a href="<?php echo addons_url('Weibo://Editor/lists');?>">微博编辑器<b class="arrow fa fa-sort-up"></b></a></li>
	...
	<div class="normal_div" style="margin-left:20px;">
		<?php echo hook('weiboEditor');?>
	</div>
